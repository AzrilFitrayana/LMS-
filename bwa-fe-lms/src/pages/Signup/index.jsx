  ...
  return (
    ...
    {mode === 'AUTH' ? (
      ...
      <div className="flex items-center justify-center gap-[109px] my-auto">
        <form onSubmit={handleSubmit(handleOnSubmit)} className="flex flex-col w-[400px] h-fit rounded-[20px] border border-[#262A56] p-[30px] gap-[30px] bg-[#080A2A]">
          <div>
          ...
          <div className="flex items-center gap-3 w-full rounded-full border p-[14px_20px] transition-all duration-300 focus-within:border-[#8661EE] focus-within:shadow-[-10px_-6px_10px_0_#7F33FF_inset] bg-[#070B24] border-[#24283E] shadow-[-10px_-6px_10px_0_#181A35_inset]">
            ...
            {errors.name?.message && <p className="text-red-500 text-xs -mt-5 ml-2">{errors.name?.message}</p>}
          <div className="flex items-center gap-3 w-full rounded-full border p-[14px_20px] transition-all duration-300 focus-within:border-[#8661EE] focus-within:shadow-[-10px_-6px_10px_0_#7F33FF_inset] bg-[#070B24] border-[#24283E] shadow-[-10px_-6px_10px_0_#181A35_inset]">
            <img
            ...
            {errors.email?.message && <p className="text-red-500 text-xs -mt-5 ml-2">{errors.email?.message}</p>}
          <div className="flex items-center gap-3 w-full rounded-full border p-[14px_20px] transition-all duration-300 focus-within:border-[#8661EE] focus-within:shadow-[-10px_-6px_10px_0_#7F33FF_inset] bg-[#070B24] border-[#24283E] shadow-[-10px_-6px_10px_0_#181A35_inset]">
            <img
          ...
          {errors.password?.message && <p className="text-red-500 text-xs -mt-5 ml-2">{errors.password?.message}</p>}
          <hr className="border-[#262A56]" />
          <button
            type="submit"
